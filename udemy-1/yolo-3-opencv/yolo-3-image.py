...
# ~= time: library to measure time spent for forward pass
import numpy as np
import cv2
import time
...
# ~= we read input image by opencv function that give us BGR image in form of numpy array
